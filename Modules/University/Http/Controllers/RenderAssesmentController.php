                        ...
                        if($cpmks){              
                            ...
                            if($recap_assesment){
                                ...
                                if($sia_marks){
                                                ...
                                                if($department){
                                                    ...
                                                    if(isset($rai["lecture_detail"]["kodematakuliah"])){
                                                        ...
                                                        $lectures = C11LecturesController::store([
                                                            ...
                                                            "semester_mk" => $rai["lecture_detail"]["semestermatakuliah"],
                                                            "tahun_ajaran" => $rai["lecture_detail"]["tahunajaran"],
                                                        ...
                                                        if($lectures){   
                                                            ...
                                                            $lecturer = C11LecturerController::store([
                                                                ...
                                                                "nidn" => $rai["lecture_detail"]["nidnnik"],
                                                                "dept_flag" => $department->flag,
                                                            ]);
                                    ...
                                    $update_stat_assesment = C11AssesmentFile::where('file_id',  $file_id)
                                                        ->update(["is_rendered" => 2, "error_message"=> "SIA Marks Failed to Be Rendered"]);
                                }
                            }else{ // end recap assesment
                                $update_stat_assesment = C11AssesmentFile::where('file_id',  $file_id)
                                                        ->update(["is_rendered" => 2, "error_message"=> "Recap Assesment Failed to Be Rendered"]);
                            }
                        }else{// end cpmks
                            $update_stat_assesment = C11AssesmentFile::where('file_id',  $file_id)
                                                        ->update(["is_rendered" => 2, "error_message"=> "CPMKs Maps Failed to Be Rendered"]);
                        }
                    }else{ // end cpls
                        $update_stat_assesment = C11AssesmentFile::where('file_id',  $file_id)
                                                        ->update(["is_rendered" => 2, "error_message"=> "CPLs Maps Failed to Be Rendered"]);
                    }
                }else{ // end rai
                    $update_stat_assesment = C11AssesmentFile::where('file_id',  $file_id)
                                                        ->update(["is_rendered" => 2, "error_message"=> "Assesment Identity Failed to Be Rendered"]);
                }
                
            }else{
                $update_stat_assesment = C11AssesmentFile::where('file_id',  $file_id)
                                                        ->update(["is_rendered" => 2, "error_message"=> "ERROR - Please Check Assesment Layout"]);
                if($update_stat_assesment){
                    return response()->json([
                        "status" => "ERROR",
