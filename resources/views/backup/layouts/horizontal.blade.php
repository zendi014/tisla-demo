                ...
                <div class="dropdown d-none d-lg-inline-block ms-1">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                        <div class="p-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="{{ url('admin/users') }}">
                                        <i data-feather="users"></i>
                                        <span>@lang('translation.user_managemet')</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="{{ url('admin/roles') }}">
                                        <i data-feather="anchor"></i>
                                        <span>@lang('translation.role_management')</span>
                                    </a>
                                </div>
                                <div class="col">
