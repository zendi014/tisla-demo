...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @if (empty($user))
            @slot('child_2_menu')
                @lang('translation.btn_create_label') @lang('translation.user_detail')
            @endslot
        @else
            @slot('child_2_menu')
                @lang('translation.btn_edit_label') @lang('translation.user_detail')
            @endslot
        @endif
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if (empty($user))
                                <div class="form-group">
                                    <label>@lang('translation.dob_label')</label>
                                    <input type="date" name="dob"
                                        class="form-control @error('dob') is-invalid @enderror @if (!$errors->has('dob') && old('dob')) is-valid @endif"
                                    value="{{ old('dob', !empty($user) ? $user->dob : null) }}">
                                    @error('dob')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
