        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-6">
                    ...
                    <h4 class="mb-3">
                        <span class="counter-value" data-target="<?php echo e(rand(10,100)); ?>">
                            <?php echo e($assesment_statistic[0]->unrendered); ?>
        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-6">
                    ...
                    <h4 class="mb-3">
                        <span class="counter-value" data-target="<?php echo e(rand(10,100)); ?>">
                            <?php echo e($assesment_statistic[0]->rendered); ?>
        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-6">
                    ...
                    <h4 class="mb-3">
                        <span class="counter-value" data-target="<?php echo e(rand(10,100)); ?>">
                            <?php echo e($assesment_statistic[0]->errendered); ?>
...
<script>
    ...
    chart.render();
</script><?php /**PATH C:\Users\ZenZen\Documents\GitHub\tisla-demo\Modules/University\Resources/views/assesment_statistic.blade.php ENDPATH**/ ?>